...
import seal_mailman from "../assets/seal_mailman.png";
import {MailboxIcon, LockIcon, LoaderIcon} from "lucide-react";
  ...
  <div className="w-full max-w-5xl bg-[#281730] rounded-2xl shadow-lg overflow-hidden flex ">
    ...
    <div className="w-full md:w-1/2 p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {isLoggingIn ? <LoaderIcon className= "w-full h-5 text-center animate-spin" /> : "Login"}
        </button>
      </form>

      <p className="text-center mt-4 text-white-600 font-iosevka">
        Don't have an account?
        <a href="/signup" className="text-[#907fb8] ml-1 hover:underline">
          Sign Up
        </a>
      </p>
    </div>
